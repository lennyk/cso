...
class AboutPageTest(TestCase):
    ...
    def test_uses_about_template(self):
        ...
        self.assertTemplateUsed(response, 'pages/thelda.html')
...
class ConstitutionPageTest(TestCase):
    ...
    def test_uses_about_template(self):
        ...
        self.assertTemplateUsed(response, 'pages/constitution.html')
...
class DatesPageTest(TestCase):
    ...
    def test_uses_about_template(self):
        ...
        self.assertTemplateUsed(response, 'pages/dates.html')
...
class CollegesPageTest(TestCase):
    ...
    def test_uses_about_template(self):
        ...
        self.assertTemplateUsed(response, 'pages/colleges.html')
